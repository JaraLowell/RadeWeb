...
{
    /// <inheritdoc />
    public partial class SafeInitialCreateWithVisitorStats : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Use SQL to create tables only if they don't exist
            // This prevents the "table already exists" error while preserving existing data
